...
def process_docstring(app, what, name, obj, options, lines):
        ...
        for i in range(nbMethods):
          if methodDocstring[n][i] == 0:
            methodIdx = i
            currentSignature = obj.__doc__[signaturePos[i]:obj.__doc__.find(")\n", signaturePos[i])+1]
        ...
        if len(lines) > 0 and methodIdx < nbMethods - 1:
          nextSignature = obj.__doc__[signaturePos[methodIdx+1]:obj.__doc__.find(")\n", signaturePos[methodIdx+1])+1]
          linesIdx = 0
