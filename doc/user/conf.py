...
project = u'Tulip User Handbook'
copyright = u'2015, Tulip Team'
...
#html_theme_path = ['./_static/scipy.css']
...
htmlhelp_basename = 'TulipUserHandbookdoc'
...
latex_documents = [
  ('index', 'TulipUserHandbook.tex', u'Tulip User Documentation',
   u'Tulip Team', 'manual'),
]
...
man_pages = [
    ('index', 'TulipUserHandbook', u'Tulip User Documentation',
     [u'Tulip Team'], 1)
]
...
texinfo_documents = [
  ('index', 'TulipUserHandbook', u'Tulip User Documentation',
   u'Tulip Team', 'TulipUserHandbook', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'TulipUserHandbook'
epub_author = u'Tulip Team'
epub_publisher = u'Tulip Team'
epub_copyright = u'2015, Tulip Team'
